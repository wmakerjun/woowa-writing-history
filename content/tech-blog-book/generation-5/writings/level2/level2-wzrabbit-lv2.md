...
source: "https://github.com/woowacourse/woowa-writing-5/blob/wzrabbit/LV2.md"
source_path: "LV2.md"
---
...
**누적 합** 알고리즘은 **특정 구간에 있는 연속된 수들의 합을 빠르게 구할 수 있는** 알고리즘이에요. **수들의 합을 미리 저장해 두었다가, 필요할 때 재사용하는 방식**을 사용하여 불필요한 연산을 줄이고 시간을 대폭 줄일 수 있답니다.
